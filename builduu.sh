...
rom_two(){
     repo init --depth=1 --no-repo-verify -u https://github.com/ProjectSakura/android -b 12
...
case "${rom}" in
 "ProjectElixir") mmma packages/apps/Settings && mmma framework/base && mka init && mka bootimage #mka bacon -j18 2>&1 | tee build.log
    ;;
